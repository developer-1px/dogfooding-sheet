...
import { largeSmall, rank, sumproduct, sample, weightAvg, arrayToText, firstLast, maxMinBy, lenStat, rangeHash, strStat, countNumeric, freqStat, rangeCsv, rangeJson, rangeSort } from './rangeOps'
