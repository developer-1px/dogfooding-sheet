...
const FUNC_NAMES = 'SUMIF|COUNTIF|COUNTBLANK|AVERAGEIF|COUNTA|SUM|AVERAGE|MIN|MAX|COUNT|MEDIAN|STDEV|VAR|ROUNDUP|ROUNDDOWN|ROUND|ABS|FLOOR|CEIL|SQRT|IF|POWER|MOD|INT|LN|LOG|EXP|CONCAT|LEN|UPPER|LOWER|LEFT|RIGHT|MID|TRIM|SUBSTITUTE|FIND|SEARCH|REPT|PROPER|TEXTJOIN|EXACT|REPLACE|TODAY|NOW|DATE|YEAR|MONTH|DAY|DAYS|WEEKDAY|EDATE|AND|OR|NOT|ISBLANK|ISNUMBER|ISTEXT|IFS|SWITCH|VLOOKUP|INDEX|MATCH|IFERROR|CHAR|CODE|VALUE|N|TRUNC|SIGN|PI|EVEN|ODD|RANDBETWEEN|RAND|GCD|LCM'
