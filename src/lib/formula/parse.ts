...
const FUNC_NAMES = 'SUMIF|COUNTIF|COUNTA|SUM|AVERAGE|MIN|MAX|COUNT|MEDIAN|STDEV|VAR|ROUNDUP|ROUNDDOWN|ROUND|ABS|FLOOR|CEIL|SQRT|IF|POWER|MOD|INT|LN|LOG|EXP|CONCAT|LEN|UPPER|LOWER|LEFT|RIGHT|MID|TRIM|TODAY|NOW|DATE|YEAR|MONTH|DAY|DAYS|AND|OR|NOT|ISBLANK|ISNUMBER|ISTEXT|VLOOKUP|INDEX|MATCH'
