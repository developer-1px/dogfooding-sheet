...
const FUNC_NAMES = 'SUM|AVERAGE|MIN|MAX|COUNT|ROUND|ABS|FLOOR|CEIL|SQRT|IF|POWER|MOD|CONCAT|LEN|UPPER|LOWER|LEFT|RIGHT|MID|TRIM|TODAY|NOW|DATE|YEAR|MONTH|DAY|DAYS|AND|OR|NOT|ISBLANK|ISNUMBER|ISTEXT|VLOOKUP|INDEX|MATCH'
