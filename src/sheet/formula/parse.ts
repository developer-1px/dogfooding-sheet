...
const FUNC_NAMES = 'SUM|AVERAGE|MIN|MAX|COUNT|ROUND|ABS|FLOOR|CEIL|SQRT|IF|POWER|MOD|CONCAT|LEN|UPPER|LOWER|LEFT|RIGHT|MID|TRIM|TODAY|NOW|DATE|YEAR|MONTH|DAY|DAYS'
