import { useEditable, type NavDir } from '../interactive-os/useEditable'
...
export function useEditState({ cells, writeCell, rowCount, colLetters }: Args) {
  ...
  // Adapt commitEdit({ dRow, dCol }) → @interactive-os/anyeditable NavDir API to keep callers untouched.
