...
export function useSheet(opts: SheetOptions = {}) {
  ...
  return {
    ...
    writeCell, writeCells, writeCellRange, toggleCheckboxCell, replaceCellsByQuery, replaceCellText, previewSheetReplacement, applySheetReplacement, clearCellValues, clearAllFormats, clipboardText, display,
