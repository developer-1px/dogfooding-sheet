...
export function useSheet(opts: SheetOptions = {}) {
  ...
  return {
    ...
    writeCell, writeCells, toggleCheckboxCell, replaceCellsByQuery, replaceCellText, previewSheetReplacement, clearCellValues, clearAllFormats, clipboardText, display,
