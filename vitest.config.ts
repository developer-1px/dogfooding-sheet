...
export default defineConfig({
  resolve: {
    alias: [
      ...
      { find: /^@aria\/engine$/, replacement: local('./src/app/interactive-os/devtoolsARIAShims.ts') },
      { find: /^@aria\/primitives$/, replacement: local('./src/app/interactive-os/devtoolsARIAShims.ts') },
      ...
      { find: /^@interactive-os\/editable$/, replacement: local('./node_modules/@interactive-os/editable/dist/index.js') },
      { find: /^@interactive-os\/playground-catalog$/, replacement: local('../playground-catalog/src/index.mjs') },
      { find: /^@interactive-os\/json-document$/, replacement: local('./node_modules/@interactive-os/json-document/dist/application/document/index.js') },
      { find: /^@interactive-os\/json-document\/react$/, replacement: local('./node_modules/@interactive-os/json-document/dist/application/react-document/index.js') },
    ],
